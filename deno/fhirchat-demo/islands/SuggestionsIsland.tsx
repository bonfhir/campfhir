      ...
      ? (
        <section class="section-padding-large is-flex is-flex-direction-column is-justify-content-center is-align-items-center suggestions_section">
          ...
          <div class="card mx-6 mb-4 styled_card">
            <div class="card-content">
              <div class="content">
                (Contextual Question) “Nullam pulvinar, orci et viverra
                lobortis, eros ante pharetra quam?”
              </div>
            </div>
          </div>
          ...
          <div class="card mx-6 mb-4 styled_card">
            <div class="card-content">
              <div class="content">
                (Question with a specific output format)“Nullam pulvinar, orci
                et viverra lobortis, eros ante?”
              </div>
            </div>
          </div>
        </section>
