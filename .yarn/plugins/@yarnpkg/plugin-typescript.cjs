    ...
    var plugin = (() => {
        ...
        function ve() {
          return {
            get(e, t, r = { miss: () => Promise.resolve() }) {
              return t().then((n) => Promise.all([n, r.miss(n)])).then(([n]) =>
                n
              );
            },
            set(e, t) {
      ...
      var Ce = I((M) => {
        ...
        function ke(e, t = (r, s) => Promise.resolve()) {
          return Object.assign(e, {
            wait(r) {
              return ke(
                e.then((s) => Promise.all([t(s, r), s])).then((s) => s[1]),
              );
            },
          });
        }
      ...
      var Ze = I((A) => {
        ...
        function ce(e, t) {
          ...
          return Object.keys(r).forEach((n) => {
            ["timeout", "headers", "queryParameters", "data", "cacheable"]
                  .indexOf(n) === -1 && (s[n] = r[n]);
          }),
            {
        ...
        var X = { Read: 1, Write: 2, Any: 3 },
          U = { Up: 1, Down: 2, Timeouted: 3 },
          _e = 2 * 60 * 1e3;
        ...
        function le(e) {
          return {
            ...
            url: e.url,
            accept: e.accept || X.Any,
          };
        }
        function ar(e, t) {
          return Promise.all(
            t.map((r) => e.get(r, () => Promise.resolve(ue(r)))),
          ).then((r) => {
        ...
        var or = ({ isTimedOut: e, status: t }) => !e && ~~t == 0,
          ir = (e) => {
            let t = e.status;
            return e.isTimedOut || or(e) ||
              ~~(t / 100) != 2 && ~~(t / 100) != 4;
          },
          cr = ({ status: e }) => ~~(e / 100) == 2,
          ur = (e, t) =>
            ir(e) ? t.onRetry(e) : cr(e) ? t.onSucess(e) : t.onFail(e);
        function Qe(e, t, r, s) {
          let n = [],
            a = $e(r, s),
            o = Le(e, s),
            ...
            b = u(
              u(
                u({ "x-algolia-agent": e.userAgent.value }, e.queryParameters),
                y,
              ),
              s.queryParameters,
            ),
                  ...
                  onRetry(j) {
                    ...
                    return j.isTimedOut && f++,
                      Promise.all([
                        ...
                        e.hostsCache.set(
                          O,
                          ue(O, j.isTimedOut ? U.Timeouted : U.Down),
                        ),
                      ]).then(() => p(h, S));
                  },
                  onFail(j) {
          ...
          return ar(e.hostsCache, t).then((h) =>
            p([...h.statelessHosts].reverse(), h.getTimeout)
          );
        }
        function lr(e) {
          let {
            ...
            p = {
              ...
              read(h, S) {
                let O = ce(S, p.timeouts.read),
                  P = () =>
                    Qe(
                      p,
                      p.hosts.filter((j) => (j.accept & X.Read) != 0),
                      h,
                      O,
                    );
                if (
                  (O.cacheable !== void 0 ? O.cacheable : h.cacheable) !== !0
                ) return P();
                let v = {
                  request: h,
                ...
                return p.responsesCache.get(
                  ...
                  () =>
                    p.requestsCache.get(
                      v,
                      () =>
                        p.requestsCache.set(v, P()).then(
                          (j) => Promise.all([p.requestsCache.delete(v), j]),
                          (j) =>
                            Promise.all([
                              p.requestsCache.delete(v),
                              Promise.reject(j),
                            ]),
                        ).then(([j, T]) => T),
                    ),
              ...
              write(h, S) {
                return Qe(
                  p,
                  p.hosts.filter((O) => (O.accept & X.Write) != 0),
                  h,
                  ce(S, p.timeouts.write),
                );
              },
            };
          return p;
        ...
        function dr(e) {
          let t = {
            ...
            add(r) {
              ...
              return t.value.indexOf(s) === -1 && (t.value = `${t.value}${s}`),
                t;
            },
          };
          return t;
        ...
        function Ye(e) {
          ...
          return Object.keys(e).map((r) =>
            pr("%s=%s", r, t(e[r]) ? JSON.stringify(e[r]) : e[r])
          ).join("&");
        }
        function $e(e, t) {
          if (
            e.method === He.MethodEnum.Get ||
            e.data === void 0 && t.data === void 0
          ) return;
      ...
      var tt = I((w) => {
        ...
        var N = F(),
          ...
          br = (e) => (t) =>
            e.transporter.read(
              { method: z.MethodEnum.Get, path: "2/abtests" },
              t,
            ),
          Pr = (e) => (t, r) =>
            e.transporter.write({
          ...
          Or = (e) => {
            let t = e.region || "us",
              ...
              s = jr.createTransporter(
                g(
                  u({ hosts: [{ url: `recommendation.${t}.algolia.com` }] }, e),
                  {
                    headers: u(
                      g(u({}, r.headers()), {
                        "content-type": "application/json",
      ...
      var jt = I((i) => {
        ...
        var Dr = (e) => {
          let t = e.appId,
            r = l.createAuth(
              e.authMode !== void 0 ? e.authMode : l.AuthMode.WithinHeaders,
              t,
              e.apiKey,
            ),
            s = q.createTransporter(g(
              u({
                hosts: [{
                  url: `${t}-dsn.algolia.net`,
                  accept: q.CallEnum.Read,
                }, { url: `${t}.algolia.net`, accept: q.CallEnum.Write }]
                  .concat(
                    l.shuffle([{ url: `${t}-1.algolianet.com` }, {
            ...
            n = {
              ...
              clearCache() {
                return Promise.all([
                  s.requestsCache.clear(),
                  s.responsesCache.clear(),
                ]).then(() => {});
              },
            };
        ...
        var Rr = (e) => (t, r) => {
          ...
          kr = (e) => (t) =>
            e.transporter.read({ method: m.MethodEnum.Get, path: "1/logs" }, t),
          Cr = () => (e) => {
          ...
          Hr = (e) => (t) =>
            e.transporter.read({ method: m.MethodEnum.Get, path: "1/keys" }, t),
          _r = (e) => (t) =>
            e.transporter.read(
              { method: m.MethodEnum.Get, path: "1/clusters" },
              t,
            ),
          Fr = (e) => (t) =>
            e.transporter.read(
              { method: m.MethodEnum.Get, path: "1/indexes" },
              t,
            ),
          Br = (e) => (t) =>
            e.transporter.read({
            ...
            let s = (n, a) =>
              Promise.all(
                Object.keys(n.taskID).map((o) =>
                  L(e)(o, { methods: { waitTask: D } }).waitTask(n.taskID[o], a)
                ),
              );
            return l.createWaitablePromise(
              e.transporter.write({
          ...
          ps = () => (e, t) => {
            for (let [r, s] of Object.entries(e.hits)) {
            ...
            if (a === k.UpdateObject) {
              for (let d of t) {
                if (d.objectID === void 0) {
                  return l.createWaitablePromise(Promise.reject(ct()));
                }
              }
            }
            return te(e)(t, a, n);
            ...
            send(s) {
              return new Promise((n) => {
                ...
                y.on("error", (h) => {
                  clearTimeout(f),
                    clearTimeout(p),
                    n({ status: 0, content: h.message, isTimedOut: !1 });
                }),
                  y.once("response", () => {
      ...
      var se = C(require("@yarnpkg/core")),
        ...
        Wt = async (e, t) => {
          var a;
          let r = se.structUtils.stringifyIdent(e),
            n = Ns(t).initIndex("npm-search");
          try {
            return ((a =
                (await n.getObject(r, { attributesToRetrieve: ["types"] }))
                  .types) == null
              ? void 0
              : a.ts) === "definitely-typed";
          } catch (o) {
            return !1;
          }
        },
      ...
      var _t = (e) => e.scope ? `${e.scope}__${e.name}` : `${e.name}`,
        Hs = async (e, t, r, s) => {
          ...
          let h = `${Ie.suggestUtils.Modifier.CARET}${p.major}`,
            S = E.structUtils.makeDescriptor(
              E.structUtils.makeIdent("types", b),
              h,
            ),
            O = E.miscUtils.mapAndFind(n.workspaces, (P) => {
              var T, V;
              let x = (T = P.manifest.dependencies.get(r.identHash)) == null
                  ? void 0
                  : T.descriptorHash,
                v = (V = P.manifest.devDependencies.get(r.identHash)) == null
                  ? void 0
                  : V.descriptorHash;
              if (x !== r.descriptorHash && v !== r.descriptorHash) {
                return E.miscUtils.mapAndFind.skip;
              }
              let j = [];
          ...
          if (typeof O != "undefined") {
            for (let [P, x] of O) e.manifest[P].set(x.identHash, x);
          } else {
            try {
        ...
        Fs = (e, t) => {
          t.publishConfig && t.publishConfig.typings &&
          (t.typings = t.publishConfig.typings),
            t.publishConfig && t.publishConfig.types &&
