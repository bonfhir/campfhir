...
module.exports = {
  ...
  factory: function (require) {
    var plugin = (() => {
      ...
      var xr = Object.getPrototypeOf, Cr = Object.prototype.hasOwnProperty;
      var W =
        ((e) =>
          typeof require < "u" ? require : typeof Proxy < "u"
            ? new Proxy(e, {
      ...
      var q =
          (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
        wr = (e, r) => {
        ...
        Je = (e, r, t, n) => {
          if (r && typeof r == "object" || typeof r == "function") {
            for (let s of br(r)) {
              !Cr.call(e, s) && s !== t && we(e, s, {
                get: () => r[s],
                enumerable: !(n = Er(r, s)) || n.enumerable,
              });
            }
          }
          return e;
      ...
      var Be = (
          ...
          Je(
            r || !e || !e.__esModule
              ? we(t, "default", { value: e, enumerable: !0 })
              : t,
            e,
          )),
        Sr = (e) => Je(we({}, "__esModule", { value: !0 }), e);
      var ve = q((ee) => {
        "use strict";
        ee.isInteger = (e) =>
          typeof e == "number"
        ...
        ee.exceedsLimit = (e, r, t = 1, n) =>
          n === !1 || !ee.isInteger(e) || !ee.isInteger(r)
            ? !1
            : (Number(r) - Number(e)) / Number(t) >= n;
        ee.escapeNode = (e, r = 0, t) => {
          let n = e.nodes[r];
          !n ||
            (t && n.type === t || n.type === "open" || n.type === "close") &&
              n.escaped !== !0 && (n.value = "\\" + n.value, n.escaped = !0);
        };
        ee.encloseBrace = (e) =>
          e.type !== "brace"
            ? !1
        ...
        ee.isInvalidBrace = (e) =>
          e.type !== "brace"
            ...
            ? !0
            : e.commas >> 0 + e.ranges >> 0 === 0 || e.open !== !0 ||
                e.close !== !0
            ? (e.invalid = !0, !0)
            : !1;
        ee.isOpenOrClose = (e) =>
      ...
      var He = q((Vn, rt) => {
        ...
        rt.exports = (e, r = {}) => {
          let t = (n, s = {}) => {
            let i = r.escapeInvalid && tt.isInvalidBrace(s),
              a = n.invalid === !0 && r.escapeInvalid === !0,
              c = "";
            if (n.value) {
              return (i || a) && tt.isOpenOrClose(n) ? "\\" + n.value : n.value;
            }
      ...
      var ht = q((es, pt) => {
        ...
        var at = st(),
          le = (e, r, t) => {
            ...
            return h >= 0 && ($ = it(m, h, f, n)),
              f.negatives = _,
              f.positives = $,
              f.result = vr(_, $, n),
              n.capture === !0
                ? f.result = `(${f.result})`
                : n.wrap !== !1 && $.length + _.length > 1 &&
                  (f.result = `(?:${f.result})`),
              le.cache[p] = f,
              f.result;
          };
        ...
        function Hr(e, r) {
          ...
          for (s = ct(r + 1, n) - 1; e < s && s <= r;) {
            i.add(s), n += 1, s = ct(r + 1, n) - 1;
          }
          return i = [...i], i.sort(kr), i;
        }
        function $r(e, r, t) {
          if (e === r) return { pattern: e, count: [], digits: 0 };
          let n = Tr(e, r), s = n.length, i = "", a = 0;
          for (let c = 0; c < s; c++) {
            let [p, m] = n[c];
            p === m ? i += p : p !== "0" || m !== "9" ? i += Lr(p, m, t) : a++;
          }
          return a && (i += t.shorthand === !0 ? "\\d" : "[0-9]"),
            { pattern: i, count: [a], digits: s };
        }
        function it(e, r, t, n) {
          let s = Hr(e, r), i = [], a = e, c;
          for (let p = 0; p < s.length; p++) {
            let m = s[p], h = $r(String(a), String(m), n), R = "";
            if (!t.isPadded && c && c.pattern === h.pattern) {
              c.count.length > 1 && c.count.pop(),
                c.count.push(h.count[0]),
                c.string = c.pattern + lt(c.count),
                a = m + 1;
              continue;
            }
            t.isPadded && (R = Or(m, t, n)),
              h.string = R + h.pattern + lt(h.count),
              i.push(h),
              a = m + 1,
              c = h;
          }
        ...
        function Or(e, r, t) {
          ...
          let n = Math.abs(r.maxLen - String(e).length),
            s = t.relaxZeros !== !1;
          switch (n) {
            case 0:
              return "";
      ...
      var Ue = q((ts, Et) => {
        ...
        var Nr = W("util"),
          At = ht(),
          dt = (e) => e !== null && typeof e == "object" && !Array.isArray(e),
          Ir = (e) => (r) => e === !0 ? Number(r) : String(r),
          Pe = (e) => typeof e == "number" || typeof e == "string" && e !== "",
          ...
          Pr = (e, r) => {
            ...
            return e.positives.length && (n = e.positives.join("|")),
              e.negatives.length && (s = `-(${t}${e.negatives.join("|")})`),
              n && s ? i = `${n}|${s}` : i = n || s,
              r.wrap ? `(${t}${i})` : i;
          },
          mt = (e, r, t, n) => {
          ...
          yt = (...e) =>
            new RangeError("Invalid range arguments: " + Nr.inspect(...e)),
          _t = (e, r, t) => {
          ...
          Ur = (e, r, t = 1, n = {}) => {
            ...
            let h = De(c) || De(p) || De(m),
              R = h ? Math.max(c.length, p.length, m.length) : 0,
              f = h === !1 && Br(e, r, n) === !1,
              $ = n.transform || Ir(f);
            if (n.toRegex && t === 1) return mt(gt(e, R), gt(r, R), !0, n);
            let _ = { negatives: [], positives: [] },
              y = (T) => _[T < 0 ? "negatives" : "positives"].push(Math.abs(T)),
              E = [],
              S = 0;
            for (; a ? s >= i : s <= i;) {
              n.toRegex === !0 && t > 1 ? y(s) : E.push(Mr($(s, S), R, f)),
                s = a ? s - t : s + t,
                S++;
            }
            return n.toRegex === !0
              ? t > 1 ? Pr(_, n) : Rt(E, null, { wrap: !1, ...n })
              : E;
          },
          Gr = (e, r, t = 1, n = {}) => {
            if (!Ae(e) && e.length > 1 || !Ae(r) && r.length > 1) {
              return _t(e, r, n);
            }
            let s = n.transform || ((f) => String.fromCharCode(f)),
              i = `${e}`.charCodeAt(0),
              a = `${r}`.charCodeAt(0),
              c = i > a,
              p = Math.min(i, a),
            ...
            let h = [], R = 0;
            for (; c ? i >= a : i <= a;) {
              h.push(s(i, R)), i = c ? i - t : i + t, R++;
            }
            return n.toRegex === !0 ? Rt(h, null, { wrap: !1, options: n }) : h;
          },
          $e = (e, r, t, n = {}) => {
            if (r == null && Pe(e)) return [e];
            if (!Pe(e) || !Pe(r)) return _t(e, r, n);
            ...
            return s.capture === !0 && (s.wrap = !0),
              ...
              Ae(t)
                ? Ae(e) && Ae(r)
                  ? Ur(e, r, t, s)
                  : Gr(e, r, Math.max(Math.abs(t), 1), s)
                : t != null && !dt(t)
                ? Dr(t, s)
                : $e(e, r, 1, t);
          };
        ...
        var qr = Ue(),
          ...
          Kr = (e, r = {}) => {
            let t = (n, s = {}) => {
              ...
              if (n.type === "comma") {
                return n.prev.type === "comma" ? "" : c ? n.value : "|";
              }
              if (n.value) return n.value;
              if (n.nodes && n.ranges > 0) {
                let h = bt.reduce(n.nodes),
                  R = qr(...h, { ...r, wrap: !1, toRegex: !0 });
                if (R.length !== 0) {
                  return h.length > 1 && R.length > 1 ? `(${R})` : R;
                }
              }
      ...
      var vt = q((ns, St) => {
        ...
        var Wr = Ue(),
          ...
          fe = (e = "", r = "", t = !1) => {
            ...
            for (let s of e) {
              if (Array.isArray(s)) for (let i of s) n.push(fe(i, r, t));
              else {for (let i of r) {
                  t === !0 && typeof i == "string" && (i = `{${i}}`),
                    n.push(Array.isArray(i) ? fe(s, i, t) : s + i);
                }}
            }
            return he.flatten(n);
          },
          jr = (e, r = {}) => {
            let t = r.rangeLimit === void 0 ? 1e3 : r.rangeLimit,
              n = (s, i = {}) => {
                s.queue = [];
                let a = i, c = i.queue;
                for (; a.type !== "brace" && a.type !== "root" && a.parent;) {
                  a = a.parent, c = a.queue;
                }
                ...
                if (
                  s.type === "brace" && s.invalid !== !0 && s.nodes.length === 2
                ) {
                  c.push(fe(c.pop(), ["{}"]));
                  return;
                }
...
`,
        ...
        var Fr = He(),
          {
            ...
            CHAR_COMMA: Xr,
            CHAR_DOT: Zr,
            CHAR_LEFT_PARENTHESES: Yr,
            CHAR_RIGHT_PARENTHESES: zr,
            CHAR_LEFT_CURLY_BRACE: Vr,
            CHAR_RIGHT_CURLY_BRACE: Jr,
            CHAR_LEFT_SQUARE_BRACKET: kt,
            CHAR_RIGHT_SQUARE_BRACKET: Lt,
            CHAR_DOUBLE_QUOTE: en,
            CHAR_SINGLE_QUOTE: tn,
            CHAR_NO_BREAK_SPACE: rn,
            CHAR_ZERO_WIDTH_NOBREAK_SPACE: nn,
          } = $t(),
          sn = (e, r = {}) => {
            if (typeof e != "string") throw new TypeError("Expected a string");
            let t = r || {},
              n = typeof t.maxLength == "number"
                ? Math.min(Tt, t.maxLength)
                : Tt;
            if (e.length > n) {
            ...
            for (y({ type: "bos" }); h < m;) {
              if (a = i[i.length - 1], f = _(), !(f === nn || f === rn)) {
                if (f === Ge) {
                ...
                if (f === Xr && R > 0) {
                  if (a.ranges > 0) {
                    a.ranges = 0;
                    let E = a.nodes.shift();
                    a.nodes = [E, { type: "text", value: Fr(a) }];
                  }
                  y({ type: "comma", value: f }), a.commas++;
                  continue;
                }
                if (f === Zr && R > 0 && a.commas === 0) {
                  let E = a.nodes;
                  if (R === 0 || E.length === 0) {
                    y({ type: "text", value: f });
                    continue;
      ...
      var Mt = q((is, Bt) => {
        ...
        var It = He(),
          ...
          X = (e, r = {}) => {
            ...
            } else t = [].concat(X.create(e, r));
            return r && r.expand === !0 && r.nodupes === !0 &&
              (t = [...new Set(t)]),
              t;
          };
        X.parse = (e, r = {}) => un(e, r);
        X.stringify = (e, r = {}) =>
          It(typeof e == "string" ? X.parse(e, r) : e, r);
        X.compile = (
          e,
          r = {},
        ) => (typeof e == "string" && (e = X.parse(e, r)), an(e, r));
        X.expand = (e, r = {}) => {
          typeof e == "string" && (e = X.parse(e, r));
          let t = on(e, r);
          return r.noempty === !0 && (t = t.filter(Boolean)),
            r.nodupes === !0 && (t = [...new Set(t)]),
            t;
        };
        X.create = (e, r = {}) =>
          e === "" || e.length < 3
      ...
      var Re = q((F) => {
        "use strict";
        var En = W("path"),
          bn = process.platform === "win32",
          {
            REGEX_BACKSLASH: xn,
            REGEX_REMOVE_BACKSLASH: Cn,
            REGEX_SPECIAL_CHARS: wn,
            REGEX_SPECIAL_CHARS_GLOBAL: Sn,
          } = me();
        F.isObject = (e) =>
          e !== null && typeof e == "object" && !Array.isArray(e);
        F.hasRegexChars = (e) => wn.test(e);
        F.isRegexChar = (e) => e.length === 1 && F.hasRegexChars(e);
        F.escapeRegex = (e) => e.replace(Sn, "\\$1");
        F.toPosixSlashes = (e) => e.replace(xn, "/");
        F.removeBackslashes = (e) => e.replace(Cn, (r) => r === "\\" ? "" : r);
        F.supportsLookbehinds = () => {
        ...
        var Kt = Re(),
          {
            ...
            CHAR_LEFT_SQUARE_BRACKET: $n,
            CHAR_PLUS: Tn,
            CHAR_QUESTION_MARK: Wt,
            CHAR_RIGHT_CURLY_BRACE: kn,
            CHAR_RIGHT_PARENTHESES: jt,
            CHAR_RIGHT_SQUARE_BRACKET: Ln,
          } = me(),
          Ft = (e) => e === Xt || e === ye,
          Qt = (e) => {
          ...
          On = (e, r) => {
            ...
            for (; m < n;) {
              ...
              if (S === !0 || g === Qe) {
                for (re++; k() !== !0 && (g = H());) {
                  ...
                  if (S !== !0 && g === je && (g = H()) === je) {
                    if (
                      f = v.isBrace = !0, _ = v.isGlob = !0, I = !0, s === !0
                    ) continue;
                    break;
                  }
                  if (S !== !0 && g === Hn) {
            ...
            t.noext === !0 && (y = !1, _ = !1);
            let w = p, B = "", o = "";
            h > 0 && (B = p.slice(0, h), p = p.slice(h), R -= h),
              w && _ === !0 && R > 0
                ? (w = p.slice(0, R), o = p.slice(R))
                : _ === !0
                ? (w = "", o = p)
                : w = p,
              w && w !== "" && w !== "/" && w !== p &&
              Ft(w.charCodeAt(w.length - 1)) && (w = w.slice(0, -1)),
              t.unescape === !0 &&
              (o && (o = Kt.removeBackslashes(o)),
                w && T === !0 && (w = Kt.removeBackslashes(w)));
            let u = {
              prefix: B,
              input: e,
              start: h,
            ...
            if (
              t.tokens === !0 &&
              (u.maxDepth = 0, Ft(g) || a.push(v), u.tokens = a),
                t.parts === !0 || t.tokens === !0
            ) {
              let M;
              for (let b = 0; b < i.length; b++) {
                let V = M ? M + 1 : h, J = i[b], Q = e.slice(V, J);
                t.tokens &&
                (b === 0 && h !== 0
                  ? (a[b].isPrefix = !0, a[b].value = B)
                  : a[b].value = Q,
                  Qt(a[b]),
                  u.maxDepth += a[b].depth),
                  (b !== 0 || Q !== "") && c.push(Q),
                  M = J;
              }
              if (M && M + 1 < e.length) {
      ...
      var er = q((ls, Jt) => {
        ...
        var ke = me(),
          ...
          {
            MAX_LENGTH: Le,
            POSIX_REGEX_SOURCE: Nn,
            REGEX_NON_SPECIAL_CHARS: In,
            REGEX_SPECIAL_CHARS_BACKREF: Bn,
            REPLACEMENTS: zt,
          } = ke,
          Mn = (e, r) => {
            if (typeof r.expandRange == "function") {
              return r.expandRange(...e, r);
            }
            e.sort();
            let t = `[${e.join("-")}]`;
            try {
          ...
          de = (e, r) =>
            `Missing ${e}: "${r}" - use "\\\\${r}" to match literal characters`,
          Vt = (e, r) => {
            if (typeof e != "string") throw new TypeError("Expected a string");
            e = zt[e] || e;
            let t = { ...r },
              n = typeof t.maxLength == "number"
                ? Math.min(Le, t.maxLength)
                : Le,
              s = e.length;
            if (s > n) {
              throw new SyntaxError(
            ...
            let i = { type: "bos", value: "", output: t.prepend || "" },
              a = [i],
              c = t.capture ? "" : "?:",
              p = Z.isWindows(r),
              m = ke.globChars(p),
            ...
            e = Z.removePrefix(e, l), s = e.length;
            let H = [],
              w = [],
              B = [],
              o = i,
              ...
              V = l.advance = () => e[++l.index] || "",
              J = () => e.slice(l.index + 1),
              Q = (A = "", O = 0) => {
                l.consumed += A, l.index += O;
              },
              Ee = (A) => {
                l.output += A.output != null ? A.output : A.value, Q(A.value);
              },
              Rr = () => {
                let A = 1;
                for (; b() === "!" && (b(2) !== "(" || b(3) === "?");) {
              ...
              C = (A) => {
                if (o.type === "globstar") {
                  let O = l.braces > 0 &&
                      (A.type === "comma" || A.type === "brace"),
                    d = A.extglob === !0 ||
                      H.length && (A.type === "pipe" || A.type === "paren");
                  A.type !== "slash" && A.type !== "paren" && !O && !d &&
                    (l.output = l.output.slice(0, -o.output.length),
                      o.type = "star",
                      o.value = "*",
                      o.output = k,
                      l.output += o.output);
                ...
                if (
                  H.length && A.type !== "paren" &&
                  (H[H.length - 1].inner += A.value),
                    (A.value || A.output) && Ee(A),
                    o && o.type === "text" && A.type === "text"
                ) {
              ...
              xe = (A, O) => {
                ...
                be("parens"),
                  ...
                  C({ type: "paren", extglob: !0, value: V(), output: x }),
                  H.push(d);
              },
              yr = (A) => {
                ...
                if (A.type === "negate") {
                  let x = k;
                  A.inner && A.inner.length > 1 && A.inner.includes("/") &&
                  (x = K(t)),
                    (x !== k || M() || /^\)+$/.test(J())) &&
                    (O = A.close = `)$))${x}`),
                    A.inner.includes("*") && (d = J()) &&
                    /^\.[^\\/.]+$/.test(d) && (O = A.close = `)${d})${x})`),
                    A.prev.type === "bos" && (l.negatedExtglob = !0);
                }
                C({ type: "paren", extglob: !0, value: u, output: O }),
                  oe("parens");
              };
                ...
                O = e.replace(
                  ...
                  (d, x, P, j, G, Ie) =>
                    j === "\\"
                      ...
                      : j === "?"
                      ? x
                        ? x + j + (G ? L.repeat(G.length) : "")
                        : Ie === 0
                        ? v + (G ? L.repeat(G.length) : "")
                        : L.repeat(P.length)
                      : j === "."
                      ? R.repeat(P.length)
                      : j === "*"
            ...
            for (; !M();) {
              ...
              if (u === "\\") {
                ...
                if (
                  x && x[0].length > 2 &&
                  (P = x[0].length, l.index += P, P % 2 !== 0 && (u += "\\")),
                    t.unescape === !0 ? u = V() : u += V(),
                    l.brackets === 0
                ) {
                  C({ type: "text", value: u });
                  continue;
              ...
              if (
                  ...
                  if (d.includes("[") && (o.posix = !0, d.includes(":"))) {
                    ...
                    if (G) {
                      o.value = P + G,
                        l.backtrack = !0,
                        V(),
                        !i.output && a.indexOf(o) === 1 && (i.output = _);
                      continue;
                    }
                  }
                }
                ...
                (u = `\\${u}`),
                  u === "]" && (o.value === "[" || o.value === "[^") &&
                  (u = `\\${u}`),
                  t.posix === !0 && u === "!" && o.value === "[" && (u = "^"),
                  o.value += u,
                  Ee({ value: u });
                continue;
              }
              if (l.quotes === 1 && u !== '"') {
                u = Z.escapeRegex(u), o.value += u, Ee({ value: u });
                continue;
              }
              if (u === '"') {
                l.quotes = l.quotes === 1 ? 0 : 1,
                  t.keepQuotes === !0 && C({ type: "text", value: u });
                continue;
              }
              if (u === "(") {
              ...
              if (u === ")") {
                if (l.parens === 0 && t.strictBrackets === !0) {
                ...
                C({ type: "paren", value: u, output: l.parens ? ")" : "\\)" }),
                  oe("parens");
                continue;
              }
              if (u === "[") {
              ...
              if (u === "]") {
                if (
                  t.nobracket === !0 ||
                  o && o.type === "bracket" && o.value.length === 1
                ) {
                ...
                let d = o.value.slice(1);
                if (
                  o.posix !== !0 && d[0] === "^" && !d.includes("/") &&
                  (u = `/${u}`),
                    o.value += u,
                    Ee({ value: u }),
                    t.literalBrackets === !1 || Z.hasRegexChars(d)
                ) continue;
                let x = Z.escapeRegex(o.value);
                if (
                  l.output = l.output.slice(0, -o.value.length),
                    t.literalBrackets === !0
                ) {
              ...
              if (u === "}") {
                ...
                if (d.dots === !0) {
                  ...
                  for (
                    let G = P.length - 1;
                    G >= 0 && (a.pop(), P[G].type !== "brace");
                    G--
                  ) P[G].type !== "dots" && j.unshift(P[G].value);
                  x = Mn(j, t), l.backtrack = !0;
                }
                if (d.comma !== !0 && d.dots !== !0) {
                  let P = l.output.slice(0, d.outputIndex),
                    j = l.tokens.slice(d.tokensIndex);
                  d.value = d.output = "\\{", u = x = "\\}", l.output = P;
                  for (let G of j) l.output += G.output || G.value;
                }
                C({ type: "brace", value: u, output: x }),
                  oe("braces"),
                  w.pop();
                continue;
              }
              ...
              if (u === ",") {
                ...
                x && B[B.length - 1] === "braces" && (x.comma = !0, d = "|"),
                  C({ type: "comma", value: u, output: d });
                continue;
              }
              if (u === "/") {
              ...
              if (u === ".") {
                ...
                if (
                  l.braces + l.parens === 0 && o.type !== "bos" &&
                  o.type !== "slash"
                ) {
              ...
              if (u === "+") {
                ...
                if (
                  o &&
                    (o.type === "bracket" || o.type === "paren" ||
                      o.type === "brace") || l.parens > 0
                ) {
                  C({ type: "plus", value: u });
                  continue;
                }
              ...
              if (o.type === "star") {
                ...
                let d = o.prev,
                  x = d.prev,
                  P = d.type === "slash" || d.type === "bos",
                  j = x && (x.type === "star" || x.type === "globstar");
                if (t.bash === !0 && (!P || A[0] && A[0] !== "/")) {
                  C({ type: "star", value: u, output: "" });
                  continue;
                }
                let G = l.braces > 0 &&
                    (d.type === "comma" || d.type === "brace"),
                  Ie = H.length && (d.type === "pipe" || d.type === "paren");
                if (!P && d.type !== "paren" && !G && !Ie) {
                  C({ type: "star", value: u, output: "" });
                  continue;
                }
                for (; A.slice(0, 3) === "/**";) {
                ...
                if (d.type === "slash" && d.prev.type !== "bos" && !j && M()) {
                  l.output = l.output.slice(0, -(d.output + o.output).length),
                    d.output = `(?:${d.output}`,
                    o.type = "globstar",
                    o.output = K(t) + (t.strictSlashes ? ")" : "|$)"),
                    o.value += u,
                    l.globstar = !0,
                    l.output += d.output + o.output,
                    Q(u);
                  continue;
                }
                if (
                  d.type === "slash" && d.prev.type !== "bos" && A[0] === "/"
                ) {
                  let Ce = A[1] !== void 0 ? "|$" : "";
                  l.output = l.output.slice(0, -(d.output + o.output).length),
                    d.output = `(?:${d.output}`,
              ...
              if (t.bash === !0) {
                O.output = ".*?",
                  (o.type === "bos" || o.type === "slash") &&
                  (O.output = g + O.output),
                  C(O);
                continue;
              }
              if (
                o && (o.type === "bracket" || o.type === "paren") &&
                t.regex === !0
              ) {
                O.output = u, C(O);
                continue;
              }
              (l.index === l.start || o.type === "slash" || o.type === "dot") &&
              (o.type === "dot"
                ? (l.output += S, o.output += S)
                : t.dot === !0
                ? (l.output += T, o.output += T)
                : (l.output += g, o.output += g),
                b() !== "*" && (l.output += _, o.output += _)), C(O);
            }
            for (; l.brackets > 0;) {
              if (t.strictBrackets === !0) {
                throw new SyntaxError(de("closing", "]"));
              }
              l.output = Z.escapeLast(l.output, "["), oe("brackets");
            }
            for (; l.parens > 0;) {
              if (t.strictBrackets === !0) {
                throw new SyntaxError(de("closing", ")"));
              }
              l.output = Z.escapeLast(l.output, "("), oe("parens");
            }
            for (; l.braces > 0;) {
              if (t.strictBrackets === !0) {
                throw new SyntaxError(de("closing", "}"));
              }
              l.output = Z.escapeLast(l.output, "{"), oe("braces");
            }
            if (
              t.strictSlashes !== !0 &&
              (o.type === "star" || o.type === "bracket") &&
              C({ type: "maybe_slash", value: "", output: `${$}?` }),
                l.backtrack === !0
            ) {
              l.output = "";
              for (let A of l.tokens) {
                l.output += A.output != null ? A.output : A.value,
                  A.suffix && (l.output += A.suffix);
              }
            }
            return l;
          };
        Vt.fastpaths = (e, r) => {
          let t = { ...r },
            n = typeof t.maxLength == "number" ? Math.min(Le, t.maxLength) : Le,
            s = e.length;
          if (s > n) {
            throw new SyntaxError(
              `Input length: ${s}, exceeds maximum allowed length: ${n}`,
          ...
          t.capture && (L = `(${L})`);
          let z = (g) =>
              g.noglobstar === !0 ? L : `(${S}(?:(?!${_}${g.dot ? m : a}).)*?)`,
            I = (g) => {
              switch (g) {
                case "*":
                  return `${y}${p}${L}`;
      ...
      var rr = q((fs, tr) => {
        ...
        var Pn = W("path"),
          ...
          Ye = Re(),
          Un = me(),
          Gn = (e) => e && typeof e == "object" && !Array.isArray(e),
          D = (e, r, t = !1) => {
            if (Array.isArray(e)) {
            ...
            let n = Gn(e) && e.tokens && e.input;
            if (e === "" || typeof e != "string" && !n) {
              throw new TypeError("Expected pattern to be a non-empty string");
            }
            let s = r || {},
              i = Ye.isWindows(r),
              a = n ? D.compileRe(e, r) : D.makeRe(e, r, !1, !0),
              c = a.state;
            delete a.state;
            let p = () => !1;
            if (s.ignore) {
            ...
            let m = (h, R = !1) => {
              let { isMatch: f, match: $, output: _ } = D.test(h, a, r, {
                  glob: e,
                  posix: i,
                }),
                y = {
              ...
              return typeof s.onResult == "function" && s.onResult(y),
                f === !1
                  ? (y.isMatch = !1, R ? y : !1)
                  : p(h)
                  ? (typeof s.onIgnore == "function" && s.onIgnore(y),
                    y.isMatch = !1,
                    R ? y : !1)
                  : (typeof s.onMatch == "function" && s.onMatch(y),
                    R ? y : !0);
            };
        ...
        D.test = (e, r, t, { glob: n, posix: s } = {}) => {
          ...
          let i = t || {},
            a = i.format || (s ? Ye.toPosixSlashes : null),
            c = e === n,
            p = c && a ? a(e) : e;
          return c === !1 && (p = a ? a(e) : e, c = p === n),
            (c === !1 || i.capture === !0) &&
            (i.matchBase === !0 || i.basename === !0
              ? c = D.matchBase(e, r, t, s)
              : c = r.exec(p)),
            { isMatch: Boolean(c), match: c, output: p };
        };
        D.matchBase = (e, r, t, n = Ye.isWindows(t)) =>
          (r instanceof RegExp ? r : D.makeRe(r, t)).test(Pn.basename(e));
        ...
        D.makeRe = (e, r = {}, t = !1, n = !1) => {
          ...
          return r.fastpaths !== !1 && (e[0] === "." || e[0] === "*") &&
            (s.output = Ze.fastpaths(e, r)),
            s.output || (s = Ze(e, r)),
            D.compileRe(s, r, t, n);
        };
        D.toRegex = (e, r) => {
      ...
      var cr = q((hs, ur) => {
        ...
        var ir = W("util"),
          ...
          N = (e, r, t) => {
            ...
            for (let h = 0; h < r.length; h++) {
              ...
              for (let $ of e) {
                let _ = R($, !0);
                !(f ? !_.isMatch : _.isMatch) ||
                  (f ? n.add(_.output) : (n.delete(_.output), s.add(_.output)));
              }
            }
            let m = (a === r.length ? [...i] : [...s]).filter((h) => !n.has(h));
            if (t && m.length === 0) {
              if (t.failglob === !0) {
                throw new Error(`No matches found for "${r.join(", ")}"`);
              }
              if (t.nonull === !0 || t.nullglob === !0) {
                return t.unescape ? r.map((h) => h.replace(/\\/g, "")) : r;
              }
            }
            return m;
          };
        ...
        N.contains = (e, r, t) => {
          if (typeof e != "string") {
            throw new TypeError(`Expected a string: "${ir.inspect(e)}"`);
          }
          if (Array.isArray(r)) return r.some((n) => N.contains(e, n, t));
          if (typeof r == "string") {
            if (ar(e) || ar(r)) return !1;
            if (e.includes(r) || e.startsWith("./") && e.slice(2).includes(r)) {
              return !0;
            }
          }
        ...
        N.capture = (e, r, t) => {
          let n = ze.isWindows(t),
            i = ae.makeRe(String(e), { ...t, capture: !0 }).exec(
              n ? ze.toPosixSlashes(r) : r,
            );
        ...
        N.parse = (e, r) => {
          ...
          for (let n of [].concat(e || [])) {
            for (let s of or(String(n), r)) t.push(ae.parse(s, r));
          }
          return t;
        };
        N.braces = (e, r) => {
      ...
      var Se = W("@yarnpkg/cli"),
        ...
        ce = class extends Se.BaseCommand {
          constructor() {
            super(...arguments);
            this.json = ue.Option.Boolean("--json", !1, {
              description: "Format the output as an NDJSON stream",
            });
            this.production = ue.Option.Boolean("--production", !1, {
              description:
                "Only install regular dependencies by omitting dev dependencies",
            });
            this.all = ue.Option.Boolean("-A,--all", !1, {
          ...
          async execute() {
            let t = await ne.Configuration.find(
              ...
              { project: n, workspace: s } = await ne.Project.find(
                t,
                this.context.cwd,
              ),
              i = await ne.Cache.find(t);
            await n.restoreInstallState({ restoreResolutions: !1 });
            let a;
            if (this.all) a = new Set(n.workspaces);
            else if (this.workspaces.length === 0) {
              if (!s) {
                throw new Se.WorkspaceRequiredError(n.cwd, this.context.cwd);
              }
              a = new Set([s]);
            } else {a = new Set(this.workspaces.map((p) =>
                n.getWorkspaceByIdent(et.structUtils.parseIdent(p))
              ));}
            for (let p of a) {
              for (
                let m of this.production
                  ? ["dependencies"]
                  : ne.Manifest.hardDependencies
              ) {
                for (let h of p.manifest.getForScope(m).values()) {
                  let R = n.tryWorkspaceByDescriptor(h);
                  R !== null && a.add(R);
                }
              }
            }
            for (let p of n.workspaces) {
              a.has(p)
                ? this.production && p.manifest.devDependencies.clear()
                : (p.manifest.installConfig = p.manifest.installConfig || {},
                  p.manifest.installConfig.selfReferences = !1,
                  p.manifest.dependencies.clear(),
                  p.manifest.devDependencies.clear(),
                  p.manifest.peerDependencies.clear(),
                  p.manifest.scripts.clear());
            }
      ...
      ce.paths = [["workspaces", "focus"]],
        ce.usage = ue.Command.Usage({
      ...
      var Ne = W("@yarnpkg/cli"),
        ge = W("@yarnpkg/core"),
        _e = W("@yarnpkg/core"),
        Y = W("@yarnpkg/core"),
        gr = W("@yarnpkg/plugin-git"),
        U = W("clipanion"),
        Oe = Be(cr()),
        Ar = W("os"),
        mr = Be(hr()),
        ...
        pe = class extends Ne.BaseCommand {
          ...
          async execute() {
            let t = await ge.Configuration.find(
                this.context.cwd,
                this.context.plugins,
              ),
              { project: n, workspace: s } = await ge.Project.find(
                t,
                this.context.cwd,
              );
            if (!this.all && !s) {
              throw new Ne.WorkspaceRequiredError(n.cwd, this.context.cwd);
            }
            await n.restoreInstallState();
            let i = this.cli.process([this.commandName, ...this.args]),
              a = i.path.length === 1 && i.path[0] === "run" &&
                  typeof i.scriptName < "u"
                ? i.scriptName
                : null;
            if (i.path.length === 0) {
            ...
            let c = this.all ? n.topLevelWorkspace : s,
              p = this.since
                ? Array.from(
                  await gr.gitUtils.fetchChangedWorkspaces({
                    ref: this.since,
                    project: n,
                  }),
                )
                : [
                  c,
                  ...this.from.length > 0
                    ? c.getRecursiveWorkspaceChildren()
                    : [],
                ],
              m = (g) =>
                Oe.default.isMatch(
                  Y.structUtils.stringifyIdent(g.locator),
                  this.from,
                ),
              ...
              R = new Set([
                ...
                ...h.map((g) => [
                  ...this.recursive
                    ? this.since
                      ? g.getRecursiveWorkspaceDependents()
                      : g.getRecursiveWorkspaceDependencies()
            ...
            if (a != null && a.includes(":")) {
              for (
                let g of n.workspaces
              ) if (g.manifest.scripts.has(a) && ($ = !$, $ === !1)) break;
            }
            for (let g of R) {
              a && !g.manifest.scripts.has(a) && !$ &&
                  !(await ge.scriptUtils.getWorkspaceAccessibleBinaries(g)).has(
                    a,
                  ) ||
                a === process.env.npm_lifecycle_event && g.cwd === s.cwd ||
                ...
                this.publicOnly && g.manifest.private === !0 || f.push(g);
            }
            let _ = this.parallel
                ? this.jobs === "unlimited"
                  ? 1 / 0
                  : Number(this.jobs) || Math.max(1, (0, Ar.cpus)().length / 2)
                : 1,
              y = _ === 1 ? !1 : this.parallel,
              E = y ? this.interlaced : !0,
              S = (0, mr.default)(_),
              T = new Map(),
              L = new Set(),
              z = 0,
              ...
              K = await _e.StreamReport.start({
                ...
                let v = async (k, { commandIndex: l }) => {
                  ...
                  try {
                    ...
                    let V = Date.now();
                    if (this.verbose) {
                      let J = t.get("enableTimers")
                        ? `, completed in ${
                          Y.formatUtils.pretty(
                            t,
                            V - M,
                            Y.formatUtils.Type.DURATION,
                          )
                        }`
                        : "";
                      g.reportInfo(
                        null,
                        `${H} Process exited (exit code ${b})${J}`,
                      );
                    }
                    return b === 130 && (re = !0, I = b), b;
                  } catch (M) {
                    throw w.end(), o.end(), await B, await u, M;
                  }
                };
                ...
                for (; T.size > 0 && !g.hasErrors();) {
                  ...
                  for (let [w, B] of T) {
                    ...
                    if (this.topological || this.topologicalDev) {
                      let u = this.topologicalDev
                        ? new Map([
                          ...B.manifest.dependencies,
                          ...B.manifest.devDependencies,
                        ])
                        : B.manifest.dependencies;
                      for (let M of u.values()) {
                        let b = n.tryWorkspaceByDescriptor(M);
                        if (
                          o = b === null ||
                            !T.has(b.anchoredLocator.locatorHash), !o
                        ) break;
                      }
                    }
                    if (
                      !!o &&
                      (L.add(B.anchoredDescriptor.descriptorHash),
                        k.push(S(async () => {
                          let u = await v(B, { commandIndex: ++z });
                          return T.delete(w),
                            L.delete(B.anchoredDescriptor.descriptorHash),
                            u;
                        })),
                        !y)
                    ) break;
                  ...
                  if (k.length === 0) {
                    let w = Array.from(T.values()).map((B) =>
                      Y.structUtils.prettyLocator(t, B.anchoredLocator)
                    ).join(", ");
                    g.reportError(
                      _e.MessageName.CYCLIC_DEPENDENCIES,
                      `Dependency cycle detected (${w})`,
                    );
                    return;
                  }
                  let H = (await Promise.all(k)).find((w) => w !== 0);
                  I === null && (I = typeof H < "u" ? 1 : I),
                    (this.topological || this.topologicalDev) &&
                    typeof H < "u" &&
                    g.reportError(
                      _e.MessageName.UNNAMED,
      ...
      pe.paths = [["workspaces", "foreach"]],
        pe.usage = U.Command.Usage({
          category: "Workspace-related commands",
      ...
      function dr(e, { prefix: r, interlaced: t }) {
        let n = e.createStreamReporter(r), s = new Y.miscUtils.DefaultStream();
        s.pipe(n, { end: !1 }),
          s.on("finish", () => {
            n.end();
          });
        ...
        if (t) return [s, i];
        let a = new Y.miscUtils.BufferStream();
        return a.pipe(s, { end: !1 }),
          a.on("finish", () => {
            s.end();
          }),
          [a, i];
      }
      function Kn(e, { configuration: r, commandIndex: t, verbose: n }) {
        if (!n) return null;
        let i = `[${Y.structUtils.stringifyIdent(e.locator)}]:`,
          a = ["#2E86AB", "#A23B72", "#F18F01", "#C73E1D", "#CCE2A3"],
          c = a[t % a.length];
        return Y.formatUtils.pretty(r, i, c);
      }
      var Wn = { commands: [ce, pe] }, jn = Wn;
      return Sr(Fn);
    })();
    /*!
